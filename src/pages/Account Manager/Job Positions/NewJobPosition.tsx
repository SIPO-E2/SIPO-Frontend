  ...
  <table className="w-full text-sm text-left text-gray-500">
    ...
    <tbody>
      <tr className="bg-white border-b">
        ...
        <td className="px-6 py-4 ">
          <input type="text" className="border-2 rounded px-2 py-1 w-[110px]  " placeholder="Reason"/>
        </td>
        <td className="px-6 py-4 ">

      ...
      <div className="flex h-screen">
        ...
        <div className="flex-grow">
          ...
          <div className="flex p-10 gap-4 ml-10 mr-10 border-top border-dark"  >
            <div className=" w-1/4">
              <div className=" flex items-center bg-white p-5 shadow rounded mb-6"style={{width: "300px", height: "150px"}}>
              ...
              <div className=" flex items-center bg-white p-5 shadow rounded">
                <div className="grid grid-cols-3 gap-4" style={{width: "740px", height: "70px"}}>
                  <div className="">
                    <label> 
                      On pipeline since
                    </label>
            ...
            <form className="flex-1 mt-0 bg-white p-5 shadow rounded" style={{height: "600px"}}>

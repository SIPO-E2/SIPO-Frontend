        ...
        <div className="flex-grow">
          ...
          <div className="ml-10 mr-10 p-4 d-flex justify-content-between border-top border-dark">
            <div className="d-flex flex-row">
              <div className="mr-20">
                <Link to="/pipeline">
                  <button className="btn btn-dark btn-lg rounded-0">
                    Pipeline
                  </button>
                </Link>
              </div>
            ...
            <table className=" w-full text-sm  rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr className="border-b dark:border-gray-700">
                  ...
                  <td className="px-6 py-4">Mariana García Gómez</td>
                  <td className="px-6 py-4">Bench</td>
                  <td className="px-6 py-4">Developer</td>
                  <td className="px-6 py-4">C2</td>
                  <td className="px-6 py-4">01/01/2021</td>
                  <td className="px-6 py-4">Mexico</td>
                ...
                <tr className="border-b dark:border-gray-700">
                  ...
                  <td className="px-6 py-4">Guillermo Valdez Contreras</td>
                  <td className="px-6 py-4">Bench</td>
                  <td className="px-6 py-4">Developer</td>
                ...
                <tr className="border-b dark:border-gray-700">
                  ...
                  <td className="px-6 py-4">Uma Umaña</td>
                  <td className="px-6 py-4">Bench</td>
                  <td className="px-6 py-4">Developer</td>
                  <td className="px-6 py-4">C2</td>
                  <td className="px-6 py-4">01/01/2021</td>
                ...
                <tr className="border-b dark:border-gray-700">
                  ...
                  <td className="px-6 py-4">Alejandra García Gómez</td>
                  <td className="px-6 py-4">Bench</td>
                  <td className="px-6 py-4">Developer</td>
                  <td className="px-6 py-4">C1</td>
                  <td className="px-6 py-4">01/01/2021</td>

...
export interface AllocationCreation
  extends Partial<
    Omit<Allocation, "id" | "activeDB" | "interviews" | "status_date">
  > {}
...
export interface JobPositionCreation
  extends Omit<
    JobPosition,
    | "id"
    | "owner_project"
...
export interface OpeningCreation
  extends Partial<
    Omit<Opening, "id" | "activeDB" | "owner_jobPosition" | "status_date">
  > {}

export interface CandidateCreation
  extends Partial<
    Omit<Candidate, "id" | "activeDB" | "personInformation" | "allocations">
  > {}

export interface PersonCreation
  extends Partial<Omit<Person, "id" | "activeDB" | "candidateInformation">> {}

export interface PipelineCreation
  extends Partial<Omit<Pipeline, "id" | "activeDB" | "candidateInformation">> {}

export interface EmployeeCreation
  extends Partial<
    Omit<
      Employee,
      "id" | "activeDB" | "status_date" | "openings" | "candidateInformation"
    >
  > {}

export interface EmployeeOpeningCreation
  extends Partial<Omit<EmployeeOpening, "id" | "activeDB">> {}

export interface BenchCreation
  extends Partial<Omit<Bench, "id" | "activeDB" | "employeeInformation">> {}

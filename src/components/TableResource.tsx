...
const TableResource = (props:Props) => {
    ...
    const filteredCandidates = candidates.filter(candidate =>{
        ...
        return (
            candidate.personInformation.name.includes(searchValueLower) ||
            candidate.id.toString().includes(searchValueLower) ||
            candidate.personInformation.division.includes(searchValueLower) ||
            candidate.personInformation.tech_stack.includes(searchValueLower)
        );
    });
